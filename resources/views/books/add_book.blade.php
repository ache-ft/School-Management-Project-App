...
<div class="card-header p-1 my-5">
    <h5 class="card-title">@lang('messages.Add_New_Book')</h5>
</div>
  <form action="/add_book/store" method="post" enctype="multipart/form-data" class="custom-form">
    @csrf
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" id="writter_name" name="writter_name" required>
      </div>
    </div>
    <div class="form-group row">
