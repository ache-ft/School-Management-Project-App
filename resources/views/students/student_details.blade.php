...
@section('main')         
    <!-- ==================================================== -->
        ...
        <div class="container m-5">
            <form action="/student_details_search_data_by_name" method="GET">
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-around " >
                  <div class="w-100 m-5 text-center">
                    <img class="w-25 "  src="{{asset('storage/studentprofile'.'/'.$student->image)}}" alt="" >
                    </div>
                <div class="card-body ">
                    ...
                    <div class="w-75 p-3">
                        ...
                        <span><b>@lang('messages.Bio') :</b></span><p>{{$student->bio}}</p>
                    </div> 

                    
                    <dl class="row">
                        <dt class="col-sm-3">@lang('messages.Admission_ID') :</dt>
                        <dd class="col-sm-9">{{$student->admission_id}}</dd>
